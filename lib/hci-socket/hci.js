...
const Hci = function (options) {
  ...
  this._scan_interval = 'scanInterval' in options? options.scanInterval :  0x0012;
  this._scan_window = 'scanWindow' in options? options.scanWindow :  0x0012;
  this._state = null;
...
Hci.prototype.setScanParameters = function (
  ...
  if (interval === undefined){
    interval = this._scan_interval;
  }

  if (window === undefined){
    window = this._scan_window;
  }
